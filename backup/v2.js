class Utility {
  ...
  class Game {
    ...
    initEvents() {
      let snakeMovement = () => {
        this.snake.move();
        console.log(this.snake.sequence);
      ...
      document.addEventListener('keydown', (event) => {
        ...
        let newDirection = this.utility.getKeyDirection(keyName);
  ...
  document.addEventListener('DOMContentLoaded', (event) => {
    ...
    playButton.addEventListener('click', (event) => {
      ...
      let handleKeyDown = (event) => {
        ...
        let newDirection = game.utility.getKeyDirection(key);
